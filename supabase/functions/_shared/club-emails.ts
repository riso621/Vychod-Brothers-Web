...
export function renderClubEmail(input:TemplateInput){
  ...
  const welcomeContent=`
    <tr><td class="pad-x" style="padding:10px 34px 18px">
      <table role="presentation" width="100%" cellspacing="0" cellpadding="0"><tr><td valign="top"><div style="color:#f1e900;font-family:Arial Black,Arial,sans-serif;font-size:24px;font-weight:900;line-height:1">VB <span style="color:#f4f3ed;font-family:Arial,Helvetica,sans-serif;font-size:10px;letter-spacing:2.4px">VÝCHOD<br>BROTHERS</span></div></td><td class="watermark" align="right" valign="middle" style="color:#15160f;font-family:Arial Black,Arial,sans-serif;font-size:80px;font-weight:900;line-height:.72">VB</td></tr></table>
      <h1 class="hero-title" style="margin:10px 0 0;color:#f5f4ed;font-family:Arial Black,Arial Narrow,Arial,sans-serif;font-size:56px;font-weight:900;letter-spacing:-2.5px;line-height:.86">VITAJ<br><span style="color:#f1e900">V CLUBE.</span></h1>
